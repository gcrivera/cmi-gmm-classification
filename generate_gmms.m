...
nmix = 1024;
model_path = 'models/mfcc/1024c/';

% Load training data
disp('Loading data...')
cmi1_data = double(readNPY('data/mfcc/t2_train_cmi1_20f.npy')');
cmi2_data = double(readNPY('data/mfcc/t2_train_cmi2_20f.npy')');
cmi3_data = double(readNPY('data/mfcc/t2_train_cmi3_20f.npy')');
cmi4_data = double(readNPY('data/mfcc/t2_train_cmi4_20f.npy')');
cmi5_data = double(readNPY('data/mfcc/t2_train_cmi5_20f.npy')');
