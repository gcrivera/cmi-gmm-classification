...
nmix = 512;
model_path = 'models/t3_512c_13f/';

% Load training data
disp('Loading data...')
cmi1_data = readNPY('data/t3_train_cmi1_13f.npy')';
cmi2_data = readNPY('data/t3_train_cmi2_13f.npy')';
cmi3_data = readNPY('data/t3_train_cmi3_13f.npy')';
cmi4_data = readNPY('data/t3_train_cmi4_13f.npy')';
cmi5_data = readNPY('data/t3_train_cmi5_13f.npy')';
